...
function createCardElement(card, index) {
    ...
    if (card.rank === 'joker') {
        ...
        jokerContent.innerHTML = `
            <img src="Card Images/joker-card.png" alt="Joker" class="joker-image">
        `;
...
function endGame() {
    ...
    if(mode === 'arcade') {
        let winner = seeWhosWinning()[0].id;
...
// Game initialization is now handled by the asset loader after assets are loaded
// initializeGame();
